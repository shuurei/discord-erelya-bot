...
import { Command, CommandStructure, CommandMessageStyle } from '../Command'
...
export class CommandManager {
    ...
    async syncSlashCommands() {
        ...
        try {
            let commandsCache = FileCache.read<any>('commands');
            ...
            if (
                ...
                commandsCache = FileCache.write('commands', { ...commandsCache, unrestrictedSlashCommandsData: sortedUnrestricted });
            }
            ...
            for (const [guildId, commands] of restrictedSlashCommandsData.entries()) {
                ...
                if (
                    ...
                    commandsCache = FileCache.write('commands', {
                        ...commandsCache,
    ...
    resolveSlashCommand(options: CommandManagerResolveSlashCommandOptions) {
    ...
    resolveMessageCommand(parts: string[]) {
        return this.messageCommands.find((cmd) => {
            const isSlashCommandStyle = cmd.messageCommand!.style === CommandMessageStyle.SLASH_COMMAND;
