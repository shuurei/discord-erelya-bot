...
export type ColorInputArgs = string | RGB;

export type DefaultColors = Omit<typeof pc, 'createColors' | 'isColorSupported'>

export type LoggerColors = DefaultColors & {
    orange: Formatter;
...
export type TextFormatter = string | ((color: LoggerColors) => string);

export type LoggerOptions = {
    prefix?: TextFormatter
}

export interface LoggerSeparatorOptions {
